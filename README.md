<br />
 <p align="center">
    ...
    <h3 align="center "><a href="https://e-cart-by-miraz.netlify.app" target="_blank" >E-Cart | VANILLA JS</a></h3>
</p>
...
2. Clone this repository
   ```sh
   git clone https://github.com/Miraz-Uddin/js-bootcamp-html-e-cart.git
   ```
3. Go to the cloned project directory
   ```sh
   cd js-bootcamp-html-e-cart
   ```
...
#### URL: https://e-cart-by-miraz.netlify.app
